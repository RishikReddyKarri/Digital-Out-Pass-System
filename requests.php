...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top " style="background:#2196f3;">
	<a class="navbar-brand"  style="color: white;" href="#">Digital Outpass&nbsp;<marquee behavior="scroll" direction="left" style="color: white; font-style: italic;">
		...
		<thead >
		  ...
		  <tbody id="myTable">
			  ...
			  //===================================================================================================
				...
				LEFT JOIN student_details i ON pd.rollnumber = i.rollnumber
				WHERE pd.status = 'PENDING'
				ORDER BY pd.sno DESC";
				//"SELECT * FROM `perpermissions_details` WHERE `status`='PENDING' ORDER BY `sno` DESC ";
