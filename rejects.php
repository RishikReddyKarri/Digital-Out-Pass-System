	...
	<table class="table table-striped table-bordered">
		<thead>
		  ...
		  <tbody id="myTable">
			  ...
			  //===================================================================================================
				$query=$query = "SELECT pd.rollnumber, sd.studentname, sd.stream, pd.prmissiontype, pd.studentType, pd.reason, pd.leavingdatetime, pd.returndatetime, pd.place, pd.contacnumber, pd.status 
				FROM perpermissions_details pd 
				INNER JOIN student_details sd ON pd.rollnumber = sd.rollnumber 
				WHERE pd.status != 'ACCEPTED' AND pd.status != 'PENDING' 
				ORDER BY pd.sno DESC";
			  ...
			  while($row = mysqli_fetch_array($sql))
			  {
					echo "<tr  scope='row'>
						...
						<td>".$row['studentType']."</td><td>".$row['reason']."</td><td>".$row['leavingdatetime']."</td> <td>".$row['returndatetime']."</td> 
